...
const FinancialOptionsSettings: React.FC = () => {
  ...
  return (
    ...
    >
      <h2 className="m-2 text-left text-gradient bg-gradient-to-r from-teal-600 to-sky-600 bg-clip-text text-xl leading-tight text-transparent pt-3xt-lg font-semibold">
